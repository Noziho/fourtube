    ...
    <fieldset>
        <form action="/?c=video&a=add-video" method="post" enctype="multipart/form-data">
            <div>
                ...
                <input id="title" type="text" name="title" placeholder="Titre de la vidéo ...">
            </div>
            ...
            <div class="margin_div_form">
                <input id="userVideoFile" type="file" name="userVideoFile" placeholder="Cliquez pour upload votre vidéo !">
            </div>
